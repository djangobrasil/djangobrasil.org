...
class ContactFormTestCase(TestCase):
    ...
    def test_from_email_field_should_raise_exception_when_value_is_not_an_valid_email(self):
        self.assertRaises(ValidationError, ContactForm.base_fields['from_email'].run_validators, 'email_invalido')
    ...
    def test_message_field_must_be_a_text_area(self):
        ...
        self.assertTrue(isinstance(contact_form_widget, Textarea),
                        "Message field's widget must be a Textarea instance, found a %s's instance" % contact_form_widget.__class__)
